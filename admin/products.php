...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['save'])) {
  ...
  $main_image = $main_image !== '' ? $main_image : ($old_img ?? '');
    ...
    <form method="post" enctype="multipart/form-data">
      ...
      <div class="row g-3">
        ...
        <div class="col-12 d-flex flex-wrap gap-4 pt-1">
          <?php /* <div class="form-check form-switch"><input class="form-check-input" type="checkbox" name="is_featured" id="f1" <?= $v['is_featured'] ? 'checked' : '' ?>><label class="form-check-label small" for="f1">Featured</label></div>
