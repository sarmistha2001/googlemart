    ...
    <div class="card">
      <div class="table-responsive">
        <table class="table data mb-0 align-middle">
          <thead><tr><th>ID</th><th>Image</th><th>Name</th><th>Slug</th><th>Icon</th><th class="text-center">Products</th><th class="text-center">Sort</th><th class="text-center">Status</th><th class="text-end">Actions</th></tr></thead>
          <tbody>
          <?php if (!$rows): ?>
            <tr><td colspan="9"><div class="empty-state"><i class="bi bi-folder"></i><div>No categories yet. Click "Add Category" to create one.</div></div></td></tr>
          <?php endif; ?>
          <?php foreach ($rows as $r): ?>
            <tr>
              ...
              <td><span class="badge bg-light text-dark border"><?= e($r['icon']) ?: '—' ?></span></td>
