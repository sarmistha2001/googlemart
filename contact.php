      ...
      <div class="col-lg-5">
        <div class="page-card h-100">
          ...
          <div class="d-flex flex-column gap-3 mt-4">
            <div class="d-flex gap-3 align-items-start"><span class="contact-icon"><i data-lucide="map-pin" style="width:20px;height:20px"></i></span><div><div class="fw-bold" style="font-size:13px">Address</div><div class="text-secondary" style="font-size:13px">Google Mart, KIIT Road, In Front of Falcon Residency, Patia, Bhubaneswar, Odisha 751024</div></div></div>
            ...
            <div class="d-flex gap-3 align-items-start"><span class="contact-icon"><i data-lucide="clock" style="width:20px;height:20px"></i></span><div><div class="fw-bold" style="font-size:13px">Working Hours</div><div class="text-secondary" style="font-size:13px">Mon – Sun: 10 AM – 9 PM</div></div></div>
          </div>
